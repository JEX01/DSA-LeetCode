<h2><a href="https://leetcode.com/problems/super-palindromes/description/?envType=problem-list-v2&envId=string">906. Super Palindromes</a></h2><h3>Hard</h3><hr><p>Let&#39;s say a positive integer is a <strong>super-palindrome</strong> if it is a palindrome, and it is also the square of a palindrome.</p>

<h2><a href="https://leetcode.com/problems/increasing-decreasing-string/?envType=problem-list-v2&envId=string">1370. Increasing Decreasing String</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code>. Reorder the string using the following algorithm:</p>
